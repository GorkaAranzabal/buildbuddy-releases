      ...
      <div className="pt-4 border-t border-zinc-700">
        ...
        <ul className="space-y-2 text-xs text-zinc-400">
          ...
          <li className="flex items-start gap-2">
            ...
            <span>
              Anonymous usage analytics: device ID, app version, events like asks, hotkeys, errors, and a coarse prompt category (e.g. "scripting"). Your prompts, screenshots, and code never leave the device for analytics. Your email is included only if you're signed in.
            </span>
          </li>
        </ul>
      </div>
